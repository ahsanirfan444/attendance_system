...
SECRET_KEY = 'u)7=0bdz(kqd$o^t5599x!p1t54whe*%hk#v8x))z31#uf80mr'
...
ROOT_URLCONF = 'lfd_attendance_system.urls'
...
WSGI_APPLICATION = 'lfd_attendance_system.wsgi.application'
